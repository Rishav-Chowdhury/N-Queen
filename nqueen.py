...
st.sidebar.markdown("#####    ")
st.sidebar.markdown("#### This Web Application provides a solution to the N-Queen Problem. It takes the number of queens as an input on the slider and computes the solutions by *Backtracking* and uses *PyPlot* to display the unique solutions visually.")
st.sidebar.markdown("# ")
st.sidebar.markdown("# ")
